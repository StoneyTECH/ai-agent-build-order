...
**Target:** `.` · **Files scanned:** 17 · **Tool:** build-order v0.1.0 · **Generated:** 2026-08-06T03:40:41.389Z
...
| 3 | Draw the scope, deny by default | ✅ HELD | static | test/audit.test.mjs:235 — 'attest.json': JSON.stringify({ gates: { scope: { attested: true, note: 'allowlist deny-by-default', receipt: 'r' } } }), |
...
| 8 | Turn failures into fixtures | ✅ HELD | static | 3 test/eval file(s): test/atlas.test.mjs, test/audit.test.mjs, test/negative-control.test.mjs<br>CI workflow present |
